...
import { TreeDataModule, RichSelectModule, LicenseManager } from "ag-grid-enterprise";
import {
  AG_GRID_LOCALE_EN,
  AG_GRID_LOCALE_FR,
  AG_GRID_LOCALE_DE,
...
ModuleRegistry.registerModules([AllCommunityModule, TreeDataModule, RichSelectModule]);
